...
import os
from com_bita.utils.file_helper import FileReader
from com_bita.utils.checker import is_number
...
class MovieReview:
    ...
    def hook(self):
        print('==== Hook ====')
        self.train()
        print(self.classify('우선 가격대비 양 특히 추가한 햄도 있는데 어마무지 적습니다 맛 집에 있는 베이컨 치즈 추가해서 먹었습니다 배달은 빨리 왔네요 비추×100입니다'))

    def load_corpus(self):
        reader = self.reader
        corpus = read_table('/Users/kuku/Desktop/anaconda/sba_api_04/com_bita/rnn/data/movie_review.csv', sep=',', encoding='UTF-8')
